...
<p>좋은 풀이가 있어 두번째 풀이로 업데이트!</p>
<p>약수의 개수는 제곱수를 통해서도 알 수 있다. 약수의 수가 짝수라면 모두 짝을 이룬다. </p>
<p>예를 들어 12의 약수는 1,12 2,6이 짝을 이루지만, 4의 약수는 1,4,2로 제곰수인 2가 들어가면서 약수의 총 개수가 홀수가 된다.</p>
<p>제곰수로 나누어지는지 확인하면 약수의 개수의 짝수,홀수 여부를 알 수 있다.</p>
